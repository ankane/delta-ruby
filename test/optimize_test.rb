...
class OptimizeTest < Minitest::Test
  def test_compact
    ...
    with_table(df) do |dt|
      ...
      assert_in_delta 504, metrics["filesRemoved"]["avg"]
      assert_equal 504, metrics["filesRemoved"]["max"]
      assert_equal 504, metrics["filesRemoved"]["min"]
      assert_equal 3, metrics["filesRemoved"]["totalFiles"]
      assert_equal 1512, metrics["filesRemoved"]["totalSize"]
